...
export default async function LoginPage({
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 flex-col justify-between bg-gradient-to-br from-sky-600 to-sky-900 p-12 text-white relative overflow-hidden">
          ...
          <div className="mb-8 lg:hidden text-center">
            <div className="flex justify-center mb-3">
              <svg
                ...
                aria-label="Oscar logo"
              >
                <circle fill="#00b0db" cx="83.45" cy="61.23" r="50.52" />
                <line stroke="#00b0db" strokeMiterlimit="10" strokeWidth="2" x1="110.85" y1="32.83" x2="154.08" y2="2.17" />
                <line stroke="#00b0db" strokeMiterlimit="10" strokeWidth="2" x1="80.42" y1="87.05" x2="76.98" y2="133.05" />
                <line stroke="#00b0db" strokeMiterlimit="10" strokeWidth="2" x1="106.82" y1="93.66" x2="146.54" y2="139.91" />
                <line stroke="#00b0db" strokeMiterlimit="10" strokeWidth="2" x1="63.09" y1="27.8" x2="48.01" y2="8.7" />
                <line stroke="#00b0db" strokeMiterlimit="10" strokeWidth="2" x1="49.69" y1="85.58" x2="19.97" y2="101.71" />
                <line stroke="#00b0db" strokeMiterlimit="10" strokeWidth="2" x1="41.98" y1="43.89" x2="2.26" y2="35.34" />
                <circle fill="#de761c" cx="153.91" cy="2.26" r="2.26" />
                <circle fill="#de761c" cx="19.99" cy="101.59" r="2.26" />
                <circle fill="#de761c" cx="146.21" cy="139.52" r="2.26" />
                <circle fill="#de761c" cx="48.12" cy="8.89" r="2.26" />
